...
| Nếu tính năng lỗi, trang sẽ bị kẹt ở phần load, không trả lại phản hồi cho khách hàng | ![không phản hồi](loading.png) | Failure | Mọi output đều nên trả lai khách hàng, kể cả không trả lời được |
